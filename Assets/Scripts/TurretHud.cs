...
{
    [Header("Components")]
    [SerializeField] private TurretMouseController mouseFlight = null;
    ...
    private void UpdateGraphics(TurretMouseController controller)
    {
        if (boresight != null)
        {
    ...
    public void SetReferenceMouseFlight(TurretMouseController controller)
    {
